...
int cgiMain()
{
	...
	strcpy(sql, "create table information(id int not null primary key, name varchar(20) not null, age int not null)");
	...
	sprintf(sql, "insert into information values('%s',%d,'%s',%d,'%s')", name,atoi(id),sex, atoi(Sid), age);
